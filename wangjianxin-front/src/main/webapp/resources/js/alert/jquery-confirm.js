    ...
    Jconfirm.prototype = {
        ...
        _setButtons: function () {
            ...
            if (this.confirmButton && $.trim(this.confirmButton) !== '') {
                this.$confirmButton = $('<button type="submit" class="btn">' + this.confirmButton + '</button>').appendTo(this.$btnc).addClass(this.confirmButtonClass);
            }
            if (this.cancelButton && $.trim(this.cancelButton) !== '') {
                this.$cancelButton = $('<button type="submit" class="btn">' + this.cancelButton + '</button>').appendTo(this.$btnc).addClass(this.cancelButtonClass);
            }
...
//                                                    '<form id="uploadForm" action="/star/create.json" method="post" enctype="multipart/form-data">' +
//                                                    ' <label>输入星座:</label> ' +
//                                                    '<input  type="text" id=star_userid" name="user_id" >'+
...
//                                                    ' <div class="buttons"><button type="submit" class="btn btn-default">确定</button>' +
//                                                    '<button type="button" class="btn btn-default" onclick="jconfirm.cancel())">取消</button</div>' +
//                                                    '</form>'+
        ...
        watchInterval: 100,
        columnClass: 'col-md-5 col-md-offset-4 col-sm-5 col-sm-offset-3 col-xs-10 col-xs-offset-1',
        onOpen: function () {
        },
        onClose: function () {
        },
