...
$(function(){
	...
	$(".start em").click(function(){
		...
		songIndex=sid;
		$("#audio").attr("src",'/resources/songs/'+sid+'.mp3');
		...
		$(this).css({
			"background":'url("/resources/images/music/T1X4JEFq8qXXXaYEA_-11-12.gif") no-repeat',
			"color":"transparent"
		});
		...
		/*换右侧图片*/
		$("#canvas1").attr("src",'/resources/images/music/'+sid+'.jpg');
...
function audioPlay(ev){
	$(".iplay").css("background",'url("/resources/images/music/T1oHFEFwGeXXXYdLba-18-18.gif") 0 0');
...
{ 	
	var ly="";
	if (s=="2") {
        ly="[00:00] 张信哲--太想爱你.[00:3]这词就不对了，**网上没找到哈哈 .[00:4]然后功能现在只是播放音乐.[00:05]代码不错.[00:08]嗯嗯"
//        ly="[00:00] 张信哲--太想爱你.[00:30] 慌乱城市中 [00:33] 连风都不自由 [00:36] 热闹的街头 [00:39] 就属我最寂寞 [00:42] 是爱的蛊惑 让我又兴起贪求的念头 有多爱我藏在柔顺背後"
	};
	if (s=="1"){
